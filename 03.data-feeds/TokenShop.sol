...
// Segunda aula (Data Feeds)
interface TokenInterface {
    function mint(address account, uint256 amount) external;
}

// This contract receives ether and mints the custom token to the user
contract TokenShop {
    ...
    receive() external payable {
        // When there is not a function that actively receives Ether, it becomes a fallback function
