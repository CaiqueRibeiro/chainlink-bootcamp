...
// Quarta aula (Tokens cross-chain com CCIP)
// Aula: https://www.youtube.com/watch?v=baq4i1WPgjM
contract TransferUSDCBasic {
    ...
    function transferUsdcToSepolia(
        ...
        Client.EVMTokenAmount memory tokenAmount = Client.EVMTokenAmount({
            token: address(usdcToken), // USDC token in sender network (avalanche fuji)
            amount: _amount
        });
        ...
        // have to approve this contract to use wallet used USDC externally
